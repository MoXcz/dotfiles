...
// Ported from omarchy-hyprmoncfg (MIT, Carmine Paolino). Styling goes
// through the Style/Color/Border shims in qs.Commons.
Item {
  id: root
  ...
  readonly property var groups: {
    ...
    contextual.push({
      ...
      bindings: [
        ...
        { keys: "R", action: "Restart the daemon after a package upgrade" },
